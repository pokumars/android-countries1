...
import com.pokumars.countrylist.BR;
...
public class FragmentDetailBindingImpl extends FragmentDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.flagImageView, 1);
        sViewsWithIds.put(R.id.countryName, 2);
        sViewsWithIds.put(R.id.capitalInDetail, 3);
        sViewsWithIds.put(R.id.callCode, 4);
        sViewsWithIds.put(R.id.populationDetail, 5);
        sViewsWithIds.put(R.id.neighbors, 6);
        sViewsWithIds.put(R.id.domain, 7);
        sViewsWithIds.put(R.id.demonym, 8);
    }
    // views
    @NonNull
